...
try:
	prox= requests.get('https://github.com/Fidakingbaloch/Kingbaloch/blob/main/proxies.txt').text
...
def morshed1():
        ...
        return ua
#-----------------------------------------------------#
vers = requests.get('https://github.com/Fidakingbaloch/Kingbaloch/blob/main/Version.txt ').text
version = str(vers)
#-------------------------------#
logo = (f"""
  \033[1;32m██╗  ██╗██╗███╗   ██╗ ██████╗ 
 ...
 \033[1;33m╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝ ╚═════╝ 
{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}]\x1b[38;5;46m AUTHOR    : KING BALOCH             
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;47mFACEBOOK  : KING BALOCH            
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;48mGITHUB    : KING BALOCH             {version}{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆""")
def linex():
        print(f'{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆')
def clear():
	os.system('clear')
...
try:
    os.system('clear')
    xnx = requests.get('https://github.com/Fidakingbaloch/Kingbaloch/blob/main/Approval.txt').text
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://github.com/Fidakingbaloch/Kingbaloch/blob/main/Approval.txt').text    
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Key%20The%20Key%20Is%20:%20'+id);os.system('am start https://wa.me/+923143494619?text='+tks),approval()
      time.sleep(9)
      approval()
  except:
    sys.exit()
